...
uint256 hashGenesisBlock("0x265c3d5b6961bbc306c839ef2752dc7867f11cb513501992d169dd1c332dfed2");
...
static const int64 nTargetTimespan = 60 * 60; // Emerald: 60 minutes
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        txNew.vout[0].nValue = 400000 * COIN;
        ...
        assert(block.hashMerkleRoot == uint256("0xf5e3fef02df00e633096d0ac1844fe3785bb864854c12e8ff3048068633f1794"));
